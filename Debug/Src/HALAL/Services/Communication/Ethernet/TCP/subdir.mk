...
OBJS += \
./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.o \
./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.o 

CPP_DEPS += \
./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.d \
./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.d 


# Each subdirectory must supply rules for building sources it contributes
Src/HALAL/Services/Communication/Ethernet/TCP/%.o Src/HALAL/Services/Communication/Ethernet/TCP/%.su Src/HALAL/Services/Communication/Ethernet/TCP/%.cyclo: ../Src/HALAL/Services/Communication/Ethernet/TCP/%.cpp Src/HALAL/Services/Communication/Ethernet/TCP/subdir.mk
...
clean: clean-Src-2f-HALAL-2f-Services-2f-Communication-2f-Ethernet-2f-TCP

clean-Src-2f-HALAL-2f-Services-2f-Communication-2f-Ethernet-2f-TCP:
	-$(RM) ./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.cyclo ./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.d ./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.o ./Src/HALAL/Services/Communication/Ethernet/TCP/ServerSocket.su ./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.cyclo ./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.d ./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.o ./Src/HALAL/Services/Communication/Ethernet/TCP/Socket.su

.PHONY: clean-Src-2f-HALAL-2f-Services-2f-Communication-2f-Ethernet-2f-TCP
