...
template <auto&... devs> struct Board {
  ...
  return ConfigBundle{
        ...
        .dfsdm_cfgs =
            DFSDM_CHANNEL_DOMAIN::template build<dfsdmN>(
                ctx.template span<DFSDM_CHANNEL_DOMAIN>()),
        .dfsdm_clk_cfgs =
    ...
    // ...
        ...
        DFSDM_CHANNEL_DOMAIN::Init<dfsdmN,cfg.dfsdm_cfgs>::init(GPIODomain::Init<gpioN>::instances,DMA_Domain::Init<dmaN>::instances);
