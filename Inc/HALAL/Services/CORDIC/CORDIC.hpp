...
public:
	...
	static void cos(int32_t *in,int32_t *out,int size);
	static void sin(int32_t *in,int32_t *out,int size);
	static void cos_and_sin(int32_t *in, int32_t *cos_out, int32_t *sin_out, int size);
