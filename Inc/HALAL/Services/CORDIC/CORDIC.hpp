...
public:
	...
	static void phase(int32_t *x, int32_t *y, int32_t *angle_out, int size); // vector (1,0) is phase 0
	static void modulus(int32_t *x, int32_t *y, int32_t *out, int size); //cannot give a value higher than 2147483392
