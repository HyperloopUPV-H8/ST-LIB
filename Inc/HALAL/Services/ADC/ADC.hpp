 ...
 *
 * This class handles the configuration, read, and correct casting of the ADC values in the ADC inputs.
 ...
 * Moreover, if the ADC used is not on the code generated by the .ioc you may need to change HAL_ADC_MspInit (all on stm32h7xx_hal_msp.c)to configure the ADC pins and channels and their DMAs.
