...
IPV4::IPV4(ip_addr_t address) : address(address) {
    string_address = std::to_string((u8_t)address.addr) + "." +
                     std::to_string((u8_t)(address.addr >> 8)) + "." +
                     std::to_string((uint8_t)(address.addr >> 16)) + "." +
                     std::to_string((uint8_t)(address.addr >> 24));
}
