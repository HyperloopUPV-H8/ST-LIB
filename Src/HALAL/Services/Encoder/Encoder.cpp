...
map<std::pair<Pin, Pin>, DoubleTimerChannel> Encoder::pin_timer_map = {
		{make_pair(PE9, PE11), {&htim1, TIM_CHANNEL_1, TIM_CHANNEL_2}},
		{make_pair(PA6, PB5), {&htim3, TIM_CHANNEL_1, TIM_CHANNEL_2}},
		{make_pair(PB5, PE11), {&htim4, TIM_CHANNEL_1, TIM_CHANNEL_2}},
		{make_pair(PC6, PC7), {&htim8, TIM_CHANNEL_1, TIM_CHANNEL_2}},
		{make_pair(PF0, PF1), {&htim23, TIM_CHANNEL_1, TIM_CHANNEL_2}},
		{make_pair(PF11, PF12), {&htim24, TIM_CHANNEL_1, TIM_CHANNEL_2}},
};

map<uint8_t, std::pair<Pin, Pin>> Encoder::service_IDs = {};

optional<uint8_t> Encoder::register_encoder(Pin pin1, Pin pin2){
	if (Encoder::pin_timer_map.contains(make_pair(pin1, pin2)))
		return nullopt;
