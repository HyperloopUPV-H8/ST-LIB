// Compiled WITHOUT STLIB_OPTIMIZED_PROTECTIONS — uses Protection_baseline.hpp
...
static Protections::Protection<float, 2>& bus_prot() {
    ...
    static Protections::Protection<float, 2> p("baseline_bus", SampleSource<float>(src_bus), defs);
    return p;
}
static Protections::Protection<float, 1>& time_prot() {
    static const std::array<Protections::RuleDefinition<float>, 1> defs = {
        Protections::Rules::time_accumulation(10.0f, 0.001f).value(),
    };
    static Protections::Protection<float, 1> p("baseline_time", SampleSource<float>(src_time), defs);
    return p;
}
static Protections::Protection<float, 1>& current_prot() {
    static const std::array<Protections::RuleDefinition<float>, 1> defs = {
        Protections::Rules::above(110.0f, 95.0f).value(),
    };
    static Protections::Protection<float, 1> p("baseline_current", SampleSource<float>(src_cur), defs);
    return p;
}
static Protections::Protection<float, 1>& range_prot() {
    static const std::array<Protections::RuleDefinition<float>, 1> defs = {
        Protections::Rules::range(-40.0f, 150.0f).value(),
    };
    static Protections::Protection<float, 1> p("baseline_range", SampleSource<float>(src_range), defs);
    return p;
}
