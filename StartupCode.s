...
Reset_Handler:
  ldr   sp, =__estack      /* set stack pointer */

/* Set VTOR to point to the relocated vector table in ITCMRAM */
  ldr r0, =0xE000ED08    /* VTOR Address */
  ldr r1, =__sisr_vector /* Address of the relocated vector table (0x00000000) */
  str r1, [r0]

/* Call Configuration Checker function */
  bl  ConfigurationChecker

/* Call the clock system initialization function.*/
  bl  SystemInit

/* Process Copy Table (Flash -> RAM) */
  ldr   r4, =__copy_table_start
  ldr   r5, =__copy_table_end
.L_loop_copy_table:
  cmp   r4, r5
  beq   .L_done_copy_table
  ldmia r4!, {r1, r2, r3} /* r1=src, r2=dest_start, r3=dest_end */
.L_loop_copy_section:
  cmp   r2, r3
  bge   .L_next_copy_section
  ldr   r0, [r1], #4
  str   r0, [r2], #4
  b     .L_loop_copy_section
.L_next_copy_section:
  b     .L_loop_copy_table
.L_done_copy_table:

/* Process Zero Table (BSS / Clear) */
  ldr   r4, =__zero_table_start
  ldr   r5, =__zero_table_end
  movs  r0, #0
.L_loop_zero_table:
  cmp   r4, r5
  beq   .L_done_zero_table
  ldmia r4!, {r1, r2} /* r1=dest_start, r2=dest_end */
.L_loop_zero_section:
  cmp   r1, r2
  bge   .L_next_zero_section
  str   r0, [r1], #4
  b     .L_loop_zero_section
.L_next_zero_section:
  b     .L_loop_zero_table
.L_done_zero_table:
